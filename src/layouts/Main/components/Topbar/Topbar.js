      ...
      <div className={classes.logoContainer}>
        <a href="/" title="thefront">
          <Image
            ...
            src={themeMode === 'light' ? 'https://res.cloudinary.com/dhkmle6ei/image/upload/v1611549488/Copy_of_Copy_of_Copy_of_Copy_of_DOGGO_jyl2nd.png' : 'https://res.cloudinary.com/dhkmle6ei/image/upload/v1611549488/Copy_of_Copy_of_Copy_of_Copy_of_DOGGO_jyl2nd.png'}
            alt="DOGGO"
            lazy={false}
          />
        </a>
